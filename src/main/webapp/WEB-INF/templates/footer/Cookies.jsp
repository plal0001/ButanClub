            ...
            <div class="col-lg-8 ">
                <div class="box ">
                    <article>
                        ...
                        <p style="padding-left: 30px;"><em>La mayoría de los navegadores aceptan como estándar a las cookies y, con independencia de las mismas, permiten o impiden en los ajustes de seguridad las cookies temporales o memorizadas.</em></p>
                        <p style="padding-left: 30px;"><em>Sin su expreso consentimiento –mediante la activación de las cookies en su navegador–XXXXX no enlazará en las cookies los datos memorizados con sus datos personales proporcionados en el momento del registro o la compra..</em></p>
                        <p style="padding-left: 30px;"><strong><em>¿Qué tipos de cookies utiliza esta página web? </em></strong></p>
                        ...
                        <p style="padding-left: 30px;"><strong><em>Cookies de terceros</em></strong><em>: La Web de XXXXX puede utilizar&nbsp;servicios de terceros que, por cuenta de XXXXX, recopilaran información con fines estadísticos, de uso del Site por parte del usuario y para la prestacion de otros servicios relacionados con la actividad del Website y otros servicios de Internet. </em></p>
                        ...
                        <p style="padding-left: 30px;"><em>Si tiene dudas sobre esta política de cookies, puede contactar con XXXXX en info@XXXXX(punto)com </em></p>
                    </article>
                </div>
            </div>
        </div>
